...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "Hospedagem.findAll", query = "SELECT h FROM Hospedagem h"),
...
public class Hospedagem implements Serializable {
	...
	public Hospedagem(Integer id, boolean reservado, boolean paga, PontoInteresse pontoInteresse,
	...
	public String toString() {
		return "br.com.turismo.core.model.Hospedagem[ id=" + id + " ]";
	}
