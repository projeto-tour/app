...
@Table(name = "trecho")
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "Trecho.findAll", query = "SELECT t FROM Trecho t"),
...
public class Trecho implements Serializable {
	...
	public Trecho(Integer id, String pontoPartida, String pontoChegada, int distancia, Percurso percurso,
			PontoInteresse pontoInteresse, Transporte transporte) {
		this.id = id;
	...
	public String toString() {
		return "br.com.turismo.core.model.Trecho[ id=" + id + " ]";
	}
