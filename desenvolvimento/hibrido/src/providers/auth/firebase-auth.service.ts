...
export class FirebaseAuthService {
    ...
    get userInfo(): IUsuario {
        if (this.authState && this.authState.auth) {
            return {
                displayName: this.authState.auth.displayName || (this.authState.auth.providerData[0] && !_.isEmpty(this.authState.auth.providerData[0].displayName) ? this.authState.auth.providerData[0].displayName : 'Nome de usuário'),
                email: this.authState.auth.email || (this.authState.auth.providerData[0] && !_.isEmpty(this.authState.auth.providerData[0].email) ? this.authState.auth.providerData[0].email : 'usuario@email.com.br'),
                photoURL: this.authState.auth.photoURL || (this.authState.auth.providerData[0] && !_.isEmpty(this.authState.auth.providerData[0].photoURL) ? this.authState.auth.providerData[0].photoURL : 'assets/img/user-woman.svg'),
            ...
            return {
                ...
                photoURL: 'assets/img/user-woman.svg',
                providerId: '',
                uid: ''
            };
        }
