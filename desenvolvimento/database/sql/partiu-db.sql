...
CREATE TABLE IF NOT EXISTS `partiu_db`.`avaliacao_usuario` (
  ...
  `recomendar` TINYINT(1) NULL,
  `data_avaliacao` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_avaliacao_ponto_interesse_idx` (`ponto_interesse_id` ASC),
  INDEX `fk_avaliacao_usuario1_idx` (`usuario_id` ASC),
  INDEX `fk_avaliacao_usuario_avaliacao1_idx` (`avaliacao_id` ASC),
...
CREATE TABLE IF NOT EXISTS `partiu_db`.`caracteristica` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `tipo_de_dados_id` BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `partiu_db`.`caracteristica_tipo_ponto_interesse` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `tipo_ponto_interesse_id` BIGINT NOT NULL,
  `caracteristica_tipo_ponto_interesse_id` BIGINT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_table1_caracteristica_tipo_ponto_interesse1_idx` (`caracteristica_tipo_ponto_interesse_id` ASC),
  INDEX `fk_table1_tipo_ponto_interesse1_idx` (`tipo_ponto_interesse_id` ASC),
